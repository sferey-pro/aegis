...
**1159 tests, 0 échec.** Chaque fichier de code porte son test à côté de lui
...
bun run test        # les deux étages (1159 tests)
bun run test:ui     # 361 tests composants — happy-dom, React, fetch simulé
bun run test:api    # 798 tests fonctionnels — vrai serveur, vraie base, vrai git
