...
**1139 tests, 0 échec.** Chaque fichier de code porte son test à côté de lui
...
bun run test        # les deux étages (1139 tests)
bun run test:ui     # 356 tests composants — happy-dom, React, fetch simulé
bun run test:api    # 783 tests fonctionnels — vrai serveur, vraie base, vrai git
