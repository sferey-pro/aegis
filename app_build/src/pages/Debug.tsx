	...
	return (
		<div className="w-full max-w-6xl mx-auto p-6 md:p-12 animate-in fade-in slide-in-from-bottom-4 duration-500 relative">
			...
			<div className="flex flex-col gap-12">
				{/* TYPOGRAPHY & COLORS */}
				<section>
					<h2 className="text-2xl font-bold mb-4 border-b pb-2">Typographie & Couleurs</h2>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-card p-6 rounded-xl border border-border">
						<div className="flex flex-col gap-4">
							<div>
								...
								<p className="text-muted-foreground text-sm">Utilisé pour les titres de page principaux.</p>
							</div>
							<div>
								<h2 className="text-3xl font-semibold border-b pb-2">Heading 2 (h2)</h2>
								<p className="text-muted-foreground text-sm">Utilisé pour les sections principales.</p>
							</div>
							<div>
								<h3 className="text-2xl font-semibold">Heading 3 (h3)</h3>
								<p className="text-muted-foreground text-sm">Utilisé pour les sous-sections.</p>
							</div>
							<div>
								<h4 className="text-xl font-semibold">Heading 4 (h4)</h4>
								<p className="text-muted-foreground text-sm">Utilisé pour les titres de widgets ou cartes.</p>
							</div>
							<div>
								<p className="leading-7">
									Paragraphe standard. Utilisé pour le texte de contenu principal. Le texte est suffisamment espacé pour être lisible, même sur de longs blocs.
								</p>
							</div>
						</div>
						<div className="flex flex-col gap-4">
							...
							<div className="flex items-center gap-4">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">Action secondaire ou fond léger</p>
								</div>
							</div>
							<div className="flex items-center gap-4">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">Actions critiques (suppression, erreur)</p>
								</div>
							</div>
							<div className="flex items-center gap-4">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">Fonds discrets ou textes secondaires</p>
								</div>
							</div>
							<div className="flex items-center gap-4">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">Survol ou éléments actifs</p>
								</div>
							</div>
						</div>
					</div>
				...
				<section>
					<h2 className="text-2xl font-bold mb-4 border-b pb-2">Formulaires (Inputs, Checkbox, Switch)</h2>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-card p-6 rounded-xl border border-border">
						...
						<div className="flex items-center space-x-2">
							...
							<Label htmlFor="disabled-check" className="text-muted-foreground">Checkbox Désactivée</Label>
						</div>
						<div className="flex items-center space-x-2">
							<Switch id="disabled-switch" disabled />
							<Label htmlFor="disabled-switch" className="text-muted-foreground">Switch Désactivé</Label>
						</div>
					</div>
				</section>
				...
				{/* MOLECULES */}
				<section>
					<h2 className="text-2xl font-bold mb-4 border-b pb-2">Molécules (Composants Composites)</h2>
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
						<div className="bg-card p-6 rounded-xl border border-border flex flex-col gap-6">
							...
							<LabelInput label="Nom du Projet" id="project-name" placeholder="Ex: Aegis" />
							<LabelInput label="Clé API" id="api-key" type="password" error="La clé API est invalide ou expirée." />
						</div>

						<div className="bg-card p-6 rounded-xl border border-border flex flex-col gap-6">
							<h3 className="font-semibold text-lg">StatCard</h3>
							<div className="p-8 bg-zinc-950 rounded-xl dark">
								<StatCard title="Failles Critiques" value={42} icon={Activity} />
							</div>
						</div>
						...
						<div className="bg-card p-6 rounded-xl border border-border flex flex-col gap-6">
							...
							<div className="flex gap-2">
								<ActionBadge label="Backend" color="indigo" onDelete={() => console.log("delete backend")} />
								<ActionBadge label="Frontend" color="blue" onDelete={() => console.log("delete frontend")} />
