...
| **POST** | `/api/config/reset` | Remet la configuration à zéro : projets, historiques, triage, tags, prompts, compte-rendus et réglages. **Conserve** la clé GHSA et le cache d'avis. Ne touche **jamais** aux projets sur le disque. |
...
| Aspect | État |
|---|---|
| Tests | **1159**, 0 échec, colocalisés (chaque fichier de code a son test à côté) |
