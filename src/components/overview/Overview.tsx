...
import { Activity, Database, GitBranch, AlertOctagon, AlertTriangle, Shield } from 'lucide-react';
...
export function Overview({
  ...
  return (
    <main className="flex-1 w-full max-w-7xl mx-auto mt-8 z-10 flex flex-col gap-8 animate-in fade-in duration-500">
