...
import { keyFrom, getCachedAdvisory, putCachedAdvisory, resolveFixedVersion } from "./index";
...
describe("Integration: GitHub Advisory", () => {
  ...
  test("keyFrom extraction priorities", () => {
    expect(keyFrom("CVE-2023-1234", "https://github.com/advisories/ghsa-1234-abcd-5678")).toEqual({ kind: "ghsa", id: "GHSA-1234-ABCD-5678" });
    expect(keyFrom("CVE-2023-1234", null)).toEqual({ kind: "cve", id: "CVE-2023-1234" });
  ...
  test("resolveFixedVersion uses cache if available", async () => {
    ...
    const res = await resolveFixedVersion({ tool: "npm", package: "axios", cve: "CVE-2024-12345" });
